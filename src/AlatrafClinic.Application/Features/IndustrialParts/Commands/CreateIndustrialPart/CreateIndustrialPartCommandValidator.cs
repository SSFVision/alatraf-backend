...
public class CreateIndustrialPartCommandValidator : AbstractValidator<CreateIndustrialPartCommand>
{
    public CreateIndustrialPartCommandValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleForEach(x => x.Units)
            .SetValidator(new CreateIndustrialPartUnitCommandValidator());
    }
}